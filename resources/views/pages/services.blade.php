...
@section('content')
                ...
                <div class="col-xxl-6 col-xl-8 text-start py-5">
                    <div class="row">
                        <div class="col-lg-9 m-auto">
                            ...
                            <h1 class="fw-bold bigTitle">A Vision To <br /><span style="color:#66AF27;"> Grow Better</span>
                            </h1>
                            <p class="fs-5 pb-3">Fière d’offrir des services informatiques aux entreprises, Solutions GA est
                                en mesure de vous proposer un service conseil pour tout ce qui a trait aux technologies de
                                l’information.Maintenance intégrale de votre système informatique et assistance technique
                                quotidienne. Maintenance intégrale de votre système informatique et assistance technique
                                quotidienne.</p>
                            <div class="row gy-2">
    ...
    <section class="secSectionLast py-5">
        <div class="container py-5">
            <div class="">
                <span class="dot"></span><label class="px-2 pb-3 fs-5">A Better Tomorrow</label><span
                    class="dot"></span>
                <h1 class="fw-bold bigTitle pb-4"><span style="color:#66AF27;">Passion</span> In Consultancy</h1>
                <p class=" pb-1">Seamlessly visualize quality intellectual capital without superior collaboration and
                    idea-sharing.<br /> Holistically pontificate installed base portals after maintainable products.</p>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 px-4 pt-5">
                    <img class="imgBorderBtm" src="images/servIcon07.svg" alt="">
                    <h2>People</h2>
                    <p>Engage worldwide methodologies with web enabled technology via process centric outside the box
                        thinking.</p>
                </div>
    ...
    <section>
        <div class="container">
            <div class="row pt-5">
                <div class="col-lg-6 col-12">
                    <img class="contentPos img-fluid" src="images/img_12.png" alt="">
                </div>
                ...
                <div class="col text-start d-flex align-content-center flex-wrap py-5">
                    ...
                    <p class="fs-5">Be on the Right Path for your Start Up with Avantage Consulting. We’re here to help
                        you with whatever your Young Business needs.</p>
        ...
        <div class="greenSection">
            <div class="text-start  text-white container py-5">
                ...
                <h1 class="fw-bold bigTitle">From your problem<br /><span style="color:#084631;">To real solution </span>
                </h1>
                <p class="greenSecParag col-lg-8">Efficiently unleash cross-media information without cross-media value.
                    Quickly maximize timely deliverables for real-time schemas. Dramatically maintain solutions.</p>
                <div class="row">
    ...
    <section>
        ...
        <div class="py-5">
            <span class="dot"></span><label class="px-2 pb-3 fs-5">Avantage Proposal</label><span
                class="dot"></span>
            <h1 class="fw-bold bigTitle pb-4"><span style="color:#66AF27;">Request</span> A Callback</h1>
            <p class=" pb-1 fs-5 col-xl-5 mx-auto">If you’d like to talk to our consulting team, contact us via the form
                ...
                <div class="row">
                    <div class="col-xl-5 text-xl-start contactBox  ps-lg-5 py-3 ">
                        <div class="ps-2">
                            ...
                            <p class="fs-5 col-xl-9 pb-3 mx-xl-0 mx-sm-auto">If you’d like to talk to our consulting team,
